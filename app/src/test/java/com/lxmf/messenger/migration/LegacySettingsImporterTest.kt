...
class LegacySettingsImporterTest {
    ...
    @Test
    fun `importAll imports notification settings when present`() = runTest {
    ...
    @Test
    fun `importAll skips null notification settings`() = runTest {
        val settings = createLegacySettings()
    ...
    @Test
    fun `importAll imports standard theme preference`() = runTest {
    ...
    @Test
    fun `importAll remaps custom theme ID when present in map`() = runTest {
    ...
    @Test
    fun `importAll skips custom theme when ID not in map`() = runTest {
    ...
    @Test
    fun `importAll handles invalid custom theme ID gracefully`() = runTest {
    ...
    @Test
    fun `importAll imports instance settings when present`() = runTest {
        val settings = createLegacySettings(
    ...
    @Test
    fun `importAll imports propagation settings when present`() = runTest {
        val settings = createLegacySettings(
    ...
    @Test
    fun `importAll imports location settings when present`() = runTest {
        val settings = createLegacySettings(
    ...
    private fun createLegacySettings(
        ...
        preferences = emptyList(), // Empty = legacy format
